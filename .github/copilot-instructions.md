...
make lint         # ruff + mypy (or eslint + prettier)
...
Use the `dual-docs-architect` skill. It classifies every write (tutorial / guide / reference / explanation × human / LLM / both) and routes to the correct file.
