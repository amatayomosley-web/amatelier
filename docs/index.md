...
- **New here?** Start with [Tutorials](tutorials/first-run.md) — guided walkthroughs from zero.
- **Need to do something specific?** See [Guides](guides/install.md) — task-oriented how-tos.
- **Looking up a flag or config key?** See [Reference](reference/cli.md) — exhaustive details.
- **Want to understand why?** See [Explanation](explanation/architecture.md) — design and rationale.
